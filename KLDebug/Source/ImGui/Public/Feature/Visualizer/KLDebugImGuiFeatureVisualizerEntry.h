...
class KLDEBUGIMGUI_API FKLDebugImGuiFeatureVisualizerEntry
{
public:
    explicit FKLDebugImGuiFeatureVisualizerEntry(const KL::Debug::ImGui::Features::Types::FeatureIndex _FeaturesIndex, const KL::Debug::ImGui::Features::VisualizerTree::NodeDataID _NodeDataID);
