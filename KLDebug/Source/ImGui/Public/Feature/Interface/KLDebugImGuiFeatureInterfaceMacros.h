...
*/
#define KL_DEBUG_CREATE_WINDOW(_Class, _EntryType) \
namespace KL::Debug::Windows \
{\
    static_assert(_EntryType != EFeatureEntryType::Count, "you must choose a valid element"); \
    static inline TKLDebugImGuiFeatureManagerEntry<_Class> Instanced_##_Class{_EntryType}; \
}
