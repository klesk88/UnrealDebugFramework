...
//void SKLDebugEditorViewport::Construct(const FArguments& InArgs)
//{
//	ParentLayout = InArgs._ParentLayout;
//	LayoutName = InArgs._LayoutName;
//	RevertToLayoutName = InArgs._RevertToLayoutName;
//
//	ViewportClient = MakeShareable(new FKLDebugEditorViewportClient());
//
...
//
//	FLevelSequenceEditorToolkit::OnOpened().AddSP(this, &SKLDebugEditorViewport::OnEditorOpened);
//
...
//				.OnValueCommitted(this, &SKLDebugEditorViewport::OnTimeCommitted)
//				.OnValueChanged(this, &SKLDebugEditorViewport::SetTime)
//				.MinValue(TOptional<double>())
//				.MaxValue(TOptional<double>())
//				.OnEndSliderMovement(this, &SKLDebugEditorViewport::SetTime)
//				.Value(this, &SKLDebugEditorViewport::GetTime)
...
//				.MinDesiredWidth(this, &SKLDebugEditorViewport::GetPlayTimeMinDesiredWidth)
//			]
//		]
//
//		+ SHorizontalBox::Slot()
...
//				.OnArrange(this, &SKLDebugEditorViewport::CacheDesiredViewportSize)
//				[
//					SNew(SVerticalBox)
//
//					+ SVerticalBox::Slot()
...
//					[
//						SNew(SBox)
//						.HeightOverride(this, &SKLDebugEditorViewport::GetDesiredViewportHeight)
//						.WidthOverride(this, &SKLDebugEditorViewport::GetDesiredViewportWidth)
//						[
//							SNew(SOverlay)
//
//							+ SOverlay::Slot()
...
//						.Visibility(this, &SKLDebugEditorViewport::GetControlsVisibility)
//						.WidthOverride(this, &SKLDebugEditorViewport::GetDesiredViewportWidth)
...
//				.WidgetIndex(this, &SKLDebugEditorViewport::GetVisibleWidgetIndex)
//
...
//
//TSharedPtr<SLevelViewport> SKLDebugEditorViewport::GetLevelViewport() const
//{
//	return ViewportWidget;
//}
//
//int32 SKLDebugEditorViewport::GetVisibleWidgetIndex() const
//{
//	return CurrentToolkit.IsValid() ? 0 : 1;
//}
//
//EVisibility SKLDebugEditorViewport::GetControlsVisibility() const
//{
//	return CurrentToolkit.IsValid() ? EVisibility::Visible : EVisibility::Collapsed;
//}
//
//TOptional<double> SKLDebugEditorViewport::GetMinTime() const
//{
...
//}
//
//TOptional<double> SKLDebugEditorViewport::GetMaxTime() const
//{
//	ISequencer* Sequencer = GetSequencer();
//	if (Sequencer)
//	{
...
//}
//
//void SKLDebugEditorViewport::OnTimeCommitted(double Value, ETextCommit::Type)
//{
//	SetTime(Value);
//}
//
//void SKLDebugEditorViewport::SetTime(double Value)
//{
...
//}
//
//double SKLDebugEditorViewport::GetTime() const
//{
//	ISequencer* Sequencer = GetSequencer();
//	if (Sequencer)
//	{
...
//}
//
//float SKLDebugEditorViewport::GetPlayTimeMinDesiredWidth() const
//{
//	ISequencer* Sequencer = GetSequencer();
//	if (Sequencer)
//	{
...
//}
//
//void SKLDebugEditorViewport::CacheDesiredViewportSize(const FGeometry& AllottedGeometry)
//{
...
//}
//
//FOptionalSize SKLDebugEditorViewport::GetDesiredViewportWidth() const
//{
//	return DesiredViewportSize.X;
//}
//
//FOptionalSize SKLDebugEditorViewport::GetDesiredViewportHeight() const
//{
//	return DesiredViewportSize.Y;
//}
//
//FReply SKLDebugEditorViewport::OnKeyDown( const FGeometry& MyGeometry, const FKeyEvent& InKeyEvent ) 
//{
...
//}
//
//void SKLDebugEditorViewport::Setup(FLevelSequenceEditorToolkit& NewToolkit)
//{
//	CurrentToolkit = StaticCastSharedRef<FLevelSequenceEditorToolkit>(NewToolkit.AsShared());
//
//	NewToolkit.OnClosed().AddSP(this, &SKLDebugEditorViewport::OnEditorClosed);
//
//	ISequencer* Sequencer = GetSequencer();
//	if (Sequencer)
//	{
...
//}
//
//void SKLDebugEditorViewport::CleanUp()
//{
...
//}
//
//void SKLDebugEditorViewport::OnEditorOpened(FLevelSequenceEditorToolkit& Toolkit)
//{
...
//}
//
//void SKLDebugEditorViewport::OnEditorClosed()
//{
//	CleanUp();
//
...
//}
//
//ISequencer* SKLDebugEditorViewport::GetSequencer() const
//{
...
//}
//
//void SKLDebugEditorViewport::Tick(const FGeometry& AllottedGeometry, const double InCurrentTime, const float InDeltaTime)
//{
