...
public:
    ...
    [[nodiscard]] bool IsDataCompressed() const;
    [[nodiscard]] bool HasReceivedAllData() const;

    [[nodiscard]] bool IsSplittedMessage() const;
    ...
    [[nodiscard]] bool IsFullyReceived(const uint32 _TotalDataReceived) const;
    [[nodiscard]] uint32 GetTotalMessageDataExpected() const;

    [[nodiscard]] uint32 GetMessageDataSize() const;
    [[nodiscard]] uint32 GetTotalUncompressDataSize() const;
    [[nodiscard]] uint32 GetTotalCompressDataSize() const;
    [[nodiscard]] uint32 GetStartCompressDataOffset() const;
    [[nodiscard]] uint32 GetMessageDataOffset() const;
    [[nodiscard]] uint16 GetMessageType() const;
    [[nodiscard]] uint16 GetMessageEnumType() const;
    [[nodiscard]] uint16 GetMessageID() const;
