...
//@begin KLDebugMod (point the _API to the right module name so we can export it in unreal

#ifndef KLDEBUGUSERTHIRDPARTYIMGUI_API
#define KLDEBUGUSERTHIRDPARTYIMGUI_API
#endif

#ifndef IMGUI_API
#define IMGUI_API KLDEBUGUSERTHIRDPARTYIMGUI_API
#endif
//@EndKLDebugMod
