...
#include "Internal/Commands/Interface/KLDebugUserNetworkingCommandInterfaceInternal.h"
...
class KLDEBUGUSERNETWORKING_API IKLDebugUserNetworkingCommandInterface : public IKLDebugUserNetworkingCommandInterfaceInternal
{
public:
