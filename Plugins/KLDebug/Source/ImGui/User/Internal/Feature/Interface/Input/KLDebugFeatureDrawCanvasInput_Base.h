 ...
 */
class KLDEBUGIMGUIUSER_API FKLDebugFeatureDrawCanvasInput_Base : public FGameplayDebuggerCanvasContext
{
public:
    explicit FKLDebugFeatureDrawCanvasInput_Base(UCanvas& _Canvas, UFont& _Font, FKLDebugImGuiFeatureContext_Base* _Context);
